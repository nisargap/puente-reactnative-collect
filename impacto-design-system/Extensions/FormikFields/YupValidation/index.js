  ...
  fields.forEach((result) => {
    ...
    if (validation) {
      if (
        ...
        resultSchemaInput[formikKey] = yup
          .string()
          .label(I18n.t(label))
          .required();
        ...
        options.forEach((option) => {
          ...
          resultSchemaMultiInput[option.value] = yup
            .string()
            .label(option.value)
            .required();
          const resultObjectMultiInput = yup
            .object()
            .shape(resultSchemaMultiInput);
